...
public final class SSLUtil {
    ...
    public static void turnOffSslChecking() throws NoSuchAlgorithmException,
        ...
        sc.init(null, UNQUESTIONING_TRUST_MANAGER, new java.security.SecureRandom());
        HttpsURLConnection.setDefaultSSLSocketFactory(sc.getSocketFactory());

    }

    public static void turnOffTSLChecking() throws NoSuchAlgorithmException,
            KeyManagementException {
        ...
        tls.init(null, UNQUESTIONING_TRUST_MANAGER, new java.security.SecureRandom());
