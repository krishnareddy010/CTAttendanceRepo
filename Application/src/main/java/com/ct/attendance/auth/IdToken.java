...
public class IdToken {
    ...
    public static IdToken parseEncodedToken( String encodedToken, String nonce ) {
        ...
        System.out.println( "token Id parts 0: " + tokenParts[0] );
        System.out.println( "token Id parts 1: " + tokenParts[1] );
        System.out.println( "token Id parts 2: " + tokenParts[2] );
        ...
        try {
            ...
            if ( !newToken.isValid( nonce ) ) {
                System.out.println( "*****************Nonce verification failed app returning***************" );
                return null;
            }
        } catch ( Exception e ) {
            e.printStackTrace();
